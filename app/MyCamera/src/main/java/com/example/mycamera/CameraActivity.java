...
public class CameraActivity extends AppCompatActivity {
    ...
    // CameraId - BackCamera=0  &  FrontCamera=1
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_takepicture).setOnClickListener(v -> takePicture());

        Intent intent = getIntent();
        if (intent != null) {
            if (intent.getStringExtra("CameraType").equalsIgnoreCase("FRONT"))
                cameraId = "1";
            else
                cameraId = "0";
    ...
    TextureView.SurfaceTextureListener textureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
            ...
            Log.d("ASdasdasda1", width + "  --  " + height);
            openCamera();
        }
...
//            texture.setDefaultBufferSize(imageDimension.getWidth(), imageDimension.getHeight());
            texture.setDefaultBufferSize(720, 1344);
